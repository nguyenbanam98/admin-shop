...
<section class="section">
  ...
  <form action="{{ route('admin.roles.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @foreach($permissionsParentItem->permissionsChildrent as $permissionsChildrentItem)
                                      ...
                                      <td class="p-0 text-center">
                                        <div class="custom-checkbox custom-control" style="margin-left: 60px; padding-left: 0px;">
                                          <input type="checkbox" name="permission_id[]" class="custom-control-input checkbox_childrent" value="{{ $permissionsChildrentItem->id }}" id="{{$permissionsChildrentItem->id}}">
    ...
    <button type="submit" class="btn btn-primary btn-sm ml-3">Add role</button>
